...
- **Full logo** — emblem plus the app name (best for websites, headers, marketing).
- **Icon** — the square app-icon / emblem (best for favicons, app stores, social avatars).

## Logos

| App | Full logo | Square icon |
|-----|-----------|-------------|
...
- CoParent, FamilyCare, and Zari use a single square logo that works for both purposes.
